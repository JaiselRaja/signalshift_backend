...
class PaymentTransaction(Base, UUIDMixin, TimestampMixin):
    ...
    # Nullable: subscription payments don't have a single booking — they
    # pay for a recurring subscription that auto-creates many bookings.
    booking_id: Mapped[uuid.UUID | None] = mapped_column(
        PG_UUID(as_uuid=True), ForeignKey("bookings.id"), nullable=True
    )
